...
public:
	...
	void preparePipelines()
	{
		...
		shaderStages[0].module = loadSPIRVShader(/*getShadersPath()*/"shaders/triangle.vert.spv");
		...
		// Load binary SPIR-V shader
		shaderStages[1].module = loadSPIRVShader(/*getShadersPath()*/"shaders/triangle.frag.spv");
		// Main entry point for the shader
